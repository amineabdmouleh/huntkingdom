...
@section('content')
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Sales Dashboard 02</h2>
								<ol class="breadcrumb">
										...
										<div class="card custom-card overflow-hidden">
											<div class="card-header border-bottom d-flex">
												...
												<div class="ms-auto float-end">
													<a href="javascript:;" class="text-muted" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fe fe-more-vertical fs-16 "></i></a>
									...
									<div class="col-sm-12 col-lg-12 col-xl-4">
										<div class="card custom-card overflow-hidden">
											<div class="card-header border-bottom">
												<div>
													<h3 class="card-title  tx-18"><label class="main-content-label tx-15">Revenue</label></h3>
												</div>
											</div>
												...
												<div class="row justify-content-center">
													<div class="col-md-12 col-lg-6 d-block mx-auto justify-content-center">
														<ul class="morris-legends">
															<li>
																<span class="d-flex"><span class="legend bg-primary rounded-circle"></span>Sales</span>
															</li>
															<li>
																<span class="d-flex justify-content-end"><span class="legend bg-primary-light-1 rounded-circle"></span>Clients</span>
															</li>
															<li>
																<span class="d-flex"><span class="legend bg-primary-light-2 rounded-circle"></span>Profits</span>
															</li>
															<li>
																<span class="d-flex justify-content-end"><span class="legend bg-primary-light-3 rounded-circle"></span>Shares</span>
															</li>
														</ul>
													</div>
												</div>
											...
											<table class="table table-bordered text-nowrap border-bottom mb-0  border" id="recentorders">
												...
												<tbody>
													...
													<tr>
														...
														<td class=""><span class="badge rounded-pill text-warning bg-warning-transparent py-1 px-2">Pending</span></td>
													...
													<tr>
														...
														<td class=""><span class="badge rounded-pill text-danger bg-danger-transparent py-1 px-2">Cancelled</span></td>
														<td class="text-dark tx-13">Malasia</td>
													</tr>
													<tr>
														<td class="font-weight-normal d-flex">
