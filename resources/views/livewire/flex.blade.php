							...
							<div class="col-xl-12 col-lg-12 col-md-12">
									...
									<div class="card-body">
										...
										<div>
											<div class="d-flex flex-row bg-light mg-b-20">
												<div class="pd-10 bg-primary-transparent">
													Flex item 1
												</div>
												<div class="pd-10 bg-primary-transparent">
													Flex item 2
									...
									<div class="card-body">
										...
										<div>
											<div class="d-flex flex-row bg-light ht-100 mg-b-20">
												<div class="pd-10 bg-primary-transparent align-self-start">
													Flex item 1
												</div>
												<div class="pd-10 bg-primary-transparent align-self-center">
													Flex item 2
												</div>
												<div class="pd-10 bg-primary-transparent align-self-end">
													Flex item 3
												</div>
												<div class="pd-10 bg-primary-transparent align-self-stretch">
													Flex item 4
												</div>
											</div>
										</div>
									...
									<div class="card-body">
										...
										<div>
											<div class="d-flex bg-light">
												<div class="pd-10 bg-primary-transparent flex-fill">
								...
								<div class="card custom-card" id="grow">
									<div class="card-body">
										...
										<div>
											<div class="d-flex bg-light">
												<div class="pd-10 bg-primary-transparent flex-grow-1">
													Flex item
												</div>
												<div class="pd-10 bg-primary-transparent">
													Flex item
									...
									<div class="card-body">
										...
										<div>
											<div class="d-flex bg-light">
												...
												<div class="pd-10 bg-primary-transparent mg-l-auto">
													Third flex item
												</div>
											</div>
										</div>
								...
								<div class="card custom-card" id="order">
									<div class="card-body">
										...
										<div>
											<div class="d-flex bg-light">
												<div class="pd-10 bg-primary-transparent order-3">
													First Item
												</div>
												<div class="pd-10 bg-primary-transparent order-2">
													Second Item
												</div>
												<div class="pd-10 bg-primary-transparent order-1">
													Third Item
												</div>
											</div>
										</div>
