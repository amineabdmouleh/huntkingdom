							...
							<div class="row row-sm">
								<div class="col-xl-12">
									<div class="text-center p-4">
										...
										<p class="px-5">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
									</div>
								</div>
							</div>
							<!-- END ROW -->
							...
							<div class="row row-sm">
								<div class="col-xl-12">
									<div class="card custom-card">
										<img src="{{asset('build/assets/img/media/team.jpg')}}" alt="img" class="rounded-6">
									</div>
								</div>
							</div>
							<!-- END ROW -->
									...
									<div class="row row-sm">
										<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
											<div class="mt-5">
												...
												<a href="javascript:;" class="btn ripple btn-primary" role="button">Contact Us</a>
											</div>
										</div>
										<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
											<div class="text-xl-end text-center">
												<img src="{{asset('build/assets/img/media/team.png')}}" alt="img" class="rounded-6">
											</div>
										</div>
									</div>
								</div>
