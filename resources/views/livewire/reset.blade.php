										...
										<div class="card-body mt-2 mb-2">
											...
											<form>
												<div class="form-group text-start">
													...
													<input class="form-control" placeholder="Enter your email" type="email" autocomplete="username">
												</div>
												<div class="form-group text-start">
												...
												<div class="form-group text-start">
													...
													<input class="form-control border-end-0" placeholder="Confirm your password" type="password" autocomplete="new-password" data-bs-toggle="password">
												</div>
												<a class="btn btn-primary btn-block mb-4" href="{{url('index')}}">Reset Password</a>
