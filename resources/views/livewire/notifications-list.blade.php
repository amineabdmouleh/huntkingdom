							...
							<ul class="notification">
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md online">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/1.jpg')}}">
											</div>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md offline">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/2.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
								...
								<li>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md online">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/3.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
								...
								<li>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md online">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/4.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
								...
								<li>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md offline">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/5.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
								...
								<li>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md offline">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/6.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
								...
								<li>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md online">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/7.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
								...
								<li>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md offline">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/8.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
								...
								<li>
									...
									<div class="notification-body">
										<div class="media mt-0">
											<div class="main-avatar avatar-md online">
												<img alt="avatar" class="rounded-6" src="{{asset('build/assets/img/users/9.jpg')}}">
											</div>
											<div class="media-body ms-3 d-flex">
												<div class="">
